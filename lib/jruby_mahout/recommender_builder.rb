...
require 'rubygems'
require 'pry'
Dir.glob('mahout/*.jar').each { |d| require d }
require 'mahout/mahout-core-0.7.jar'
require 'mahout/mahout-integration-0.7.jar'
require 'mahout/mahout-math-0.7.jar'
require 'mahout/mahout-buildtools-0.7.jar'
require 'mysql-connector-java-5.1.26-bin.jar'
module JrubyMahout
